...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = "/Users/User/Desktop/WeeklyTaskDELEGATES-master/Files/data.csv";  // change to appropriate path
        private string _tsvPath = "/Users/User/Desktop/WeeklyTaskDELEGATES-master/Files/data.tsv";  // change to appropriate path

        private string _writeFile = "/Users/User/Desktop/WeeklyTaskDELEGATES-master/Files/data.txt";  // change to appropriate path
